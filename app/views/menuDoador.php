...
<body>
    <header>
        <a class="voltar"><img src="../../public/assets/arrow.png"></a>
        <h2>Doe+</h2>
        <a class="perfil"><img src="../../public/assets/perfil.png"></a>
    </header>
    <main>
        <ul class="menu">
            <li><a target="_self" href="./itens.html"><div class="icone"><img src="../../public/assets/doar.svg"></div><div class="texto">Realizar Doação</div></a></li>
